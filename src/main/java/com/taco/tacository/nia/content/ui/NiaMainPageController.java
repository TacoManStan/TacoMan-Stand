...
import com.taco.tacository.util.values.formulas.pathfinding.AStarNode;
import com.taco.tacository.util.values.formulas.pathfinding.AStarPathfinder;
import com.taco.tacository.util.values.formulas.pathfinding.DummyElement;
import com.taco.tacository.util.values.formulas.pathfinding.PathfindingTest;
...
@Component
@FxmlView("/fxml/nia/nia_main_page.fxml")
@Scope("prototype")
public class NiaMainPageController extends UIPageController<GameViewPage>
    ...
    protected NiaMainPageController(FxWeaver weaver, ConfigurableApplicationContext ctx) {
        super(weaver, ctx);
    }
