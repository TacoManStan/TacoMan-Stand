...
public class ImageButton
    ...
    public ImageButton(
        ...
        this(springable,
             name,
             Bind.constStringBinding(imageId),
             imagePane,
             actionResponder,
             actionResponderFX,
             toggleable,
    ...
    public ImageButton(
        ...
        this.hoveredBinding = Bind.directBoolBinding(this.imagePane.hoverProperty());
        this.pressedBinding = Bind.directBoolBinding(this.imagePane.pressedProperty());
    ...
    private void initPropertyListeners() {
        selectedProperty.addListener((observable, oldValue, newValue) -> {
            if (newValue && !isToggleable())
                throw Exc.unsupported("Image Button \"" + getName() + "\" is not toggleable and can therefore not be selected.");
        });
    ...
    public final PaintData paintData(String suffix) {
        return switch (suffix) {
            ...
            default -> throw Exc.unsupported("Suffix \"" + suffix + "\" is not supported.");
        };
    }
     ...
     * <p><b>Details</b></p>
     * <ol>
     *     <li>The {@link #getImageId() Image ID} is used to load references to the {@link Stuff#getImage(String, String, String) Cached} {@link Image Images}.</li>
     ...
     * @see #imageIdBinding()
     * @see #getPathIdOLD()
     * @see Stuff#getImage(String, String, String)
     */
    ...
    public final class PaintData {
        ...
        private @NotNull ObjectBinding<Image> generateImageBinding() {
            return Bindings.createObjectBinding(() -> {
                Image image = Stuff.getImage(ImageButton.this.getPathId(), ImageButton.this.getFormattedImageId(), "png");
                if (image != null) {
                    ...
                    image = Stuff.getImage(ImageButton.this.getPathIdOLD(), ImageButton.this.getFormattedImageId() + suffix, "png");
        ...
        private Image missingno() {
            return Stuff.getImage("buttons/missingno/", "missingno" + suffix, "png");
        }
