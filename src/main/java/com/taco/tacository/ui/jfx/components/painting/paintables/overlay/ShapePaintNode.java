...
public abstract class ShapePaintNode extends PaintNode {
    ...
    public final Paint setFill(Paint newValue) { return Props.setProperty(fillProperty, newValue); }
    ...
    public final Paint setStroke(Paint newValue) { return Props.setProperty(strokeProperty, newValue); }
