...
import com.taco.tacository.ui.jfx.components.button.BoundImageButtonGroup;
import com.taco.tacository.ui.jfx.components.button.ButtonViewable;
import com.taco.tacository.ui.jfx.components.button.ImageButtonGroup;
...
public class SidebarBookshelf extends UIBookshelf {
    ...
    public SidebarBookshelf(@NotNull Sidebar owner, @Nullable StackPane contentPane, @NotNull String name, boolean selectOnAdd) {
        ...
        Exc.nullCheck(owner, "Sidebar (Owner/Parent)");
