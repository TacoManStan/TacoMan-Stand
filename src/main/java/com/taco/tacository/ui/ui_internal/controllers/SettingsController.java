...
import com.taco.tacository.ui.content.TransitionContentView;
import com.taco.tacository.ui.jfx.dialog.DialogController;
import com.taco.tacository.ui.ui_internal.settings.SettingContainer;
import com.taco.tacository.ui.ui_internal.settings.SettingGroup;
import com.taco.tacository.ui.ui_internal.settings.SettingsTitledPane;
...
public class SettingsController extends DialogController<Void>
{
    ...
    @Override public void initialize()
    {
        ...
        this.selectedGroupBinding = Bind.recursiveBinding(
                (TitledPane pane) -> pane != null
                        ? ((SettingsTitledPane) pane).selectedGroupProperty()
                        : Bind.constObjBinding(null),
    ...
    {
        Exc.nullCheck(settingContainer, "Setting Container");
