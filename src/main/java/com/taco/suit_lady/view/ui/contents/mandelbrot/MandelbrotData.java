...
public class MandelbrotData
    ...
    public MandelbrotData(Springable springable, double xMin, double yMin, double xMax, double yMax, double width, double height) {
    ...
    public static @NotNull MandelbrotData newDefaultInstance(Springable springable, double width, double height) {
        return new MandelbrotData(springable, -2.2, -1.2, .8, 1.2, width, height);
    }
