...
import com.taco.suit_lady.view.ui.ui_internal.settings.SettingGroup;
import com.taco.suit_lady.view.ui.ui_internal.settings.SettingsTitledPane;
...
public class SettingsController extends DialogController<Void>
{
    ...
    @Override public void initialize()
    {
        ...
        this.selectedGroupBinding = BindingTools.get().recursiveBinding(
                (TitledPane pane) -> pane != null
                        ? ((SettingsTitledPane) pane).selectedGroupProperty()
                        : BindingTools.get().objBinding(null),
