...
public class MandelbrotContentData extends ContentData<MandelbrotContent, MandelbrotContentData, MandelbrotContentController, MandelbrotFooter, MandelbrotFooterController>
    ...
    public final @NotNull Point2D convertFromCanvas(Point2D point) {
        Exceptions.nullCheck(point, "Conversion Point");
    ...
    public static @NotNull MandelbrotContentData newDefaultInstance(Springable springable) {
        return MandelbrotContentData.newDefaultInstance(springable, 0.0, 0.0);
    }
