...
public abstract class UIPage<C extends UIPageController<?>>
    ...
    public UIPage(@NotNull UIBook owner, Object... constructorParams) {
        ExceptionsSL.nullCheck(owner, "Springable Parent (UIBook Owner)");
        
        this.weaver = ExceptionsSL.nullCheck(owner.weaver(), "FxWeaver");
        this.ctx = ExceptionsSL.nullCheck(owner.ctx(), "ApplicationContext");
        this.owner = owner;
