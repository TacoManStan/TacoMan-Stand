...
@Component
@FxmlView("/fxml/sidebar/pages/client_instance_list_page_old/client_instance_element.fxml")
@Scope("prototype")
public class ClientInstanceElementController extends CellController<DummyClient> {
    ...
    public ClientInstanceElementController(FxWeaver weaver, ConfigurableApplicationContext ctx) {
        super(weaver, ctx);
    }
    ...
    @Override
    protected void onContentChange(DummyClient oldCellContents, DummyClient newCellContents) {
