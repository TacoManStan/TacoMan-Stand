...
@FxmlView("/fxml/sidebar/pages/mandelbrot/mandelbrot_list/mandelbrot_list_page.fxml")
public class MandelbrotListPageController extends UIPageController<MandelbrotListPage> {
    ...
    protected MandelbrotListPageController(FxWeaver weaver, ConfigurableApplicationContext ctx) {
        super(weaver, ctx);
