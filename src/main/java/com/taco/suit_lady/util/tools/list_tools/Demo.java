...
import com.taco.suit_lady.util.tools.list_tools.ListTools.Operation;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        final ObservableList<String> list = Demo.initTestList();
        ...
        ListTools.applyListener(lock, list, (op1, op2, opType, triggerType) -> Demo.printListEvent(op1, op2, opType, triggerType, null, false));
        
        Demo.testPrints(list, null);
    }
