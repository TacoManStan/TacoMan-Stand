...
import com.taco.suit_lady.view.ui.jfx.fxtools.FXGraphicTools;
...
public class ColorWrapper
	...
	public ColorWrapper(Color color) {
		...
		this.awtColorProperty.bind(Bindings.createObjectBinding(() -> FXGraphicTools.toAWTColor(getColor()), colorProperty));
		this.setColor(color);
	}
